...
rule fair_rnaseq_salmon_quant_unzip_multiqc_data:
    ...
    output:
        mqc=multiext(
            "tmp/fair_rnaseq_salmon_quant/unzip_multiqc_data/{species}.{build}.{release}/multiqc",
            "_citations.txt",
            "_data.json",
            "_general_stats.txt",
            "_sources.txt",
        ...
        fqc=multiext(
            "tmp/fair_rnaseq_salmon_quant/unzip_multiqc_data/{species}.{build}.{release}/fastqc",
            "_adapter_content_plot.txt",
            "_per_base_n_content_plot.txt",
            "_per_base_sequence_quality_plot.txt",
            "_per_sequence_gc_content_plot_Counts.txt",
            "_per_sequence_gc_content_plot_Percentages.txt",
            "_per_sequence_quality_scores_plot.txt",
            "_sequence_counts_plot.txt",
            "_sequence_duplication_levels_plot.txt",
            "-status-check-heatmap.txt",
            "_top_overrepresented_sequences_table.txt",
        ),
        fastp=multiext(
            "tmp/fair_rnaseq_salmon_quant/unzip_multiqc_data/{species}.{build}.{release}/fastp",
            "_filtered_reads_plot.txt",
            "-insert-size-plot.txt",
            "-seq-content-gc-plot_Read_1_After_filtering.txt",
            "-seq-content-gc-plot_Read_1_Before_filtering.txt",
            "-seq-content-gc-plot_Read_2_After_filtering.txt",
            "-seq-content-gc-plot_Read_2_Before_filtering.txt",
            "-seq-content-n-plot_Read_1_After_filtering.txt",
            "-seq-content-n-plot_Read_1_Before_filtering.txt",
            "-seq-content-n-plot_Read_2_After_filtering.txt",
            "-seq-content-n-plot_Read_2_Before_filtering.txt",
            "-seq-quality-plot_Read_1_After_filtering.txt",
            "-seq-quality-plot_Read_1_Before_filtering.txt",
            "-seq-quality-plot_Read_2_After_filtering.txt",
            "-seq-quality-plot_Read_2_Before_filtering.txt",
        ),
    threads: 1
    resources:
        mem_mb=lambda wildcards, attempt: attempt * 512,
